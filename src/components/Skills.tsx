  ...
  return (
    <section className="my-12 pb-8">
      ...
      <div className=" flex flex-wrap gap-8 lg:gap-20 justify-center mb-12">
        <div className="flex flex-col items-center bg-gray-300 text-slate-800 dark:text-white dark:bg-slate-900 text-xl border-2 border-[#e67e22] w-32 h-32 justify-center rounded-full ">
